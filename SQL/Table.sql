...
CREATE TABLE EMPLOYEE (
    ...
    CONSTRAINT role_chk CHECK (ROLE IN ('ADMIN','TTV','KTV','TK'))
);
...
-- ===========================================
-- 3. BẢNG LƯU NHẬT KÝ LOGIN
-- ===========================================

-- 3.1 Bảng EMPLOYEE_LOGIN_AUDIT: audit login nhân viên
...
-- 3.2 Bảng CUSTOMER_LOGIN_AUDIT: audit login khách hàng
