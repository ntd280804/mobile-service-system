...
{
    public class ImportInvoiceTemplate : IPdfTemplate<ImportStockDto>
    {
        public byte[] GeneratePdf(ImportStockDto dto, PdfTemplateContext context)
        {
            ...
            var document = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Content().Stack(stack =>
                    {
                        ...
                        stack.Item().Element(content => BuildItemsTable(content, dto.Items ?? new List<ImportItemDto>(), culture));
        ...
        private static void BuildHeader(PageDescriptor page, ImportStockDto dto, PdfTemplateContext context)
        {
        ...
        private static void BuildItemsTable(IContainer container, IList<ImportItemDto> items, CultureInfo culture)
        {
